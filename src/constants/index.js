...
export const PROJECTS = [
  {
    ...
    technologies: ["Next.js", "Ts", "AppWrite", "Plaid", "Dwolla","Zod", "Chart.js", "Shad.cn"],
  },
  {
    title: "AI Placement Management System",
    image: project1,
    description:
      "Designed and implemented an AI-driven placement managementsystem to streamline the recruitment process. Developed backend algorithms using PyTorch for efficient data processing and predictive analytics. Also chat supoort for students to connect with mentors and mentoal health support.",
