        ...
        <div className="overflow-x-hidden antialiased text-neutral-300 selection:bg-cyan-300 selection:text-cyan-900">
          ...
          <div className="container px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
            ...
            <main id="main-content">
              ...
              <LazySection id="about" minHeight="600px">
                <Suspense fallback={null}>
                  <About />
                </Suspense>
              </LazySection>

              <LazySection id="technologies" minHeight="800px">
                <Suspense fallback={null}>
                  <Technologies />
                </Suspense>
              </LazySection>

              <LazySection id="experience" minHeight="1000px">
                <Suspense fallback={null}>
                  <Experience />
                </Suspense>
              </LazySection>

              <LazySection id="projects" minHeight="1200px">
                <Suspense fallback={null}>
                  <Projects />
                </Suspense>
              </LazySection>

              <LazySection id="contact" minHeight="800px">
                <Suspense fallback={null}>
                  <Contact />
                </Suspense>
              </LazySection>
